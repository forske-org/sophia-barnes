...
export default async function Page () {
    const data = await Query(`SELECT * FROM SOBARNES.PUBLIC.WORK WHERE id_person = 1 AND type IN ('review', 'book','essay');`) as Work[]
    ...
    return (
        <div className={styles.main}>
            <section className={styles.article}>
                <p>Sophia has published chapters in the edited collections <i>Doris Lessing's</i> The Golden Notebook <i>After Fifty</i> (Palgrave Macmillan 2015) and <i>Doris Lessing and the Forming of History</i> (Edinburgh University Press 2016). She is co-editor with Mark Byron of <i>Ezra Pound and Olga Rudge's</i> The Blue Spill: <i>A Manuscript Critical Edition</i> (Bloomsbury 2019).</p>
            </section>
            <section className={styles.article}>
